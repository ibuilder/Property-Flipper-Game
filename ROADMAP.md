...
| --- | --- | --- | --- |
| Example | House Flipper | â€” | Landlord Go, Real Estate Tycoon |
...
Meanwhile the tycoon end of the market is built on clicker economics â€” arbitrage on price ticks,
...
for that audience â€” and it is the audience this project's author already works in.
...
reach, and â€” directly relevant to the next phase â€” *the world should visibly transform as a result
...
| Idea | Status |
| --- | --- |
| More property types and locations | **Done** â€” 7 archetypes, 6 neighborhoods |
| More diverse upgrades | **Done** â€” 18 scope items across 8 categories |
| More detailed market simulation (gentrification) | **Done** â€” multi-year neighborhood arcs |
| More complex event types and chains | **Done** â€” chains with probabilistic links |
| Improved UI/UX (visual properties, graphs, tooltips) | **Partial** â€” tooltips and copy done, visuals are Phase 1 |
| Difficulty levels | **Done** â€” four campaigns times three settings |
| More staff types (specialists, agents) | **Done** â€” a crew on the payroll |
| Player XP and levelling alongside cash-bought skills | **Done** |
| Auctions and bidding | **Done** â€” trustee sales with proxy bidding |
| AI competitors | **Done** â€” rival buyers on every listing |
| Tenant management | **Done** â€” Phase 4 (BRRRR) |
...
### Phase 1 â€” Make the state visible â€” **done**
...
1. **Procedural house illustrations.** SVG facades generated from data the property already has:
   ...
   decay â€” boarded windows, gapped shingles, stained siding, an overgrown yard. Seeded from the
...
No new stack â€” SVG and Canvas in the existing React app, ~20â€“30 kB. Explicitly **not** a game
engine; see Â§6.

### Phase 2 â€” Depth in the deal â€” **partly done**
...
- ~~**Pick your own comps.**~~ **Done.** Choose from a pool of seven; each is priced by the same
  ...
  predicted. Required adding a scale effect to valuation â€” smaller homes carry a higher price per
  foot â€” without which a size-mismatched comp cost nothing and the warning was empty advice.
- ~~**Seller archetypes.**~~ **Done.** Estate, tired landlord, relocating, retail, developer, each
  with its own ask bias, reserve, patience, and â€” the one that matters â€” how much of a disclosed
  defect it will concede.
- ~~**Appraisal gap.**~~ **Done.** Buyer offers are cash or financed. Financed buyers bid higher but
  bring a lender's appraisal, and the price falls to it when it comes in low â€” so the highest offer
...
### Phase 3 â€” Progression that survives run three â€” **partly done**

- ~~**Reputation**~~ **Done.** Three tracks â€” lenders, agents, contractors â€” earned by outcomes
...
- ~~**Crew and staff**~~ **Done.** People on the payroll instead of subs per job: cheaper, faster
  and fewer surprises up to capacity â€” and owed wages every day, including the ones where everything
...
- ~~**XP and levelling**~~ **Done.** A third currency alongside cash-bought skills and earned
  reputation. Experience comes only from doing the work â€” closing, selling, winning at auction,
  letting, refinancing â€” cannot be bought or hurried, and grants a skill point per level rather than
...
- ~~**Explicit difficulty settings**~~ **Done.** Three settings expressed as one small table of
  ...
  harness measures are untouched â€” and nothing here touches the arithmetic the game teaches. The
...
### Phase 4 â€” A world with other people in it â€” **partly done**
...
- ~~**AI competitors**~~ **Done.** Every listing carries a rival-interest level driven by how good
  ...
  deliberate, and an offer that only just clears the seller's reserve can be sniped â€” so a good
...
- ~~**Auctions**~~ **Done.** Trustee sales on their own board: the opening bid is the lender's
  ...
  come occupied â€” which costs cash and 45 days of carry before a crew can start. Bidding is by
...
- ~~**BRRRR**~~ **Done.** Rent rather than sell: tenants who sign at a rate that depends on how far
  ...
  that a cash-out refinance sized by the *lesser* of a 75% LTV cap and a 1.20Ã— DSCR test, so a
  house bought at retail will not refinance however much equity it has â€” which is precisely why
...
- ~~**Gentrification and decline**~~ **Done.** Multi-year arcs rather than events: a neighborhood
  ...
  first stretch â€” so the information is early rather than free. By the time the map says the
...
- ~~**Event chains**~~ **Done.** A rate spike tends toward a correction, a boom toward a materials
  ...
  for the day's random one rather than arriving on top of it â€” otherwise "chains" is just a word for
  more events.

### Phase 5 â€” Make it teach deliberately â€” **mostly done**
...
- ~~**Deal post-mortems.**~~ **Done.** The projection is captured at the moment of purchase and
  ...
  called out.
- ~~**Scenario editor.**~~ **Done.** Author a deal â€” house, defects and which are disclosed, seller,
  market, clock, pass mark â€” and share it as a self-contained code. Nothing has to be hosted.
...
- **Shareable deal cards** â€” an image of your best or worst flip. Free distribution.

### Phase 6 â€” Distribution â€” **wired, pending credentials**
...
- ~~**Code signing.**~~ **Wired.** Windows signing with a timestamp server, and macOS signing with
  ...
  the credentials exist as repository secrets â€” and producing a working unsigned build when they do
  not. What cannot be done from a repository is buy the identities: a Windows certificate is
  $200â€“400/year from a CA, and macOS needs Apple Developer Program membership at $99/year. See
...
- ~~**Verify the macOS and Linux builds.**~~ **Done, differently.** Verifying on real hardware is
  ...
  and asserts the renderer actually mounts â€” which catches the class of failure that motivated the
...
Phase 1 â†’ Phase 2 â†’ Phase 5 â†’ Phase 3 â†’ Phase 4 â†’ Phase 6.
...
twenty hours â€” worth doing, but only after the teaching case was fully made.

**What is left is not code:**

1. **Buy the signing identities.** A Windows code signing certificate ($200â€“400/year) and Apple
...
3. **Publish.** itch.io first â€” the single-file browser build is already the right shape for it.
...
- **A game.** Ship on itch and Steam. Phases 3 and 4 matter most â€” progression, competitors,
  auctions, BRRRR.
- **A teaching tool.** Serve the market Cornell and Wharton charge for. Phases 2 and 5 matter most â€”
  deal depth, post-mortems, the scenario editor, curriculum.
- **Both.** Sequence as in Â§5, which is built to keep both doors open for as long as possible.

The phases overlap heavily, so this is a question of order rather than direction â€” but it decides
...
- [House Flipper review â€” Game Informer](https://gameinformer.com/review/house-flipper/a-definite-fixer-upper)
- [House Flipper: The Ultimate Guide â€” Real Estate Skills](https://www.realestateskills.com/blog/house-flipper-game)
- [For house flippers, reality doesn't match reality TV â€” Seattle Times](https://www.seattletimes.com/business/real-estate/for-house-flippers-reality-doesnt-match-reality-tv/)
- [Real Estate Investment Modeling â€” eCornell](https://ecornell.cornell.edu/certificates/real-estate/real-estate-investment-modeling/)
- [Real Estate Investing Certificate â€” Wharton Online & Wall Street Prep](https://wallstreetprep.wharton.upenn.edu/real-estate-investing-certificate/)
- [Adventures in CRE](https://www.adventuresincre.com/)
- [15 Best Property Management Simulation Games â€” Zeevou](https://zeevou.com/blog/property-management-simulation-games/)
- [Idle vs Incremental vs Tycoon â€” AndrÃ© Guerrero](https://medium.com/tindalos-games/idle-vs-incremental-vs-tycoon-understanding-the-core-mechanics-f12d62f4b9f7)
- [Roblox Tycoon Games 2026: Builds, Loops and Economies â€” Gaming Endsights](https://endsights.com/roblox-tycoon-games)
...
### A. The Weekly Plat â€” market news with consequences Â· **done**

The world is silent between decisions. The digest fixed dead air after a
*skip*; nothing speaks during ordinary play.

A right rail: newspaper masthead, then items with a kicker, a headline, and â€”
the part that matters â€” **an effect line naming what it does to your board**
...
### B. The traffic curve, drawn Â· **done**
...
### C. The guided first fifteen minutes Â· **done**
...
rentals stay locked until the tutorial deal closes â€” win or lose. The
...
### D. The isometric board · **done**

Largest, and the only item with a real dependency: **it needs commissioned art
to not be a downgrade from the map that exists now.** The full spec â€”
projection maths, tile size, the four data views, three zoom levels, pin
anatomy â€” is in the handoff. Put the projection in one module and have both the
...
- ~~**Widen the contrast audit.**~~ **Done.** Seven scenes â€” menu, market, the
  deal modal, an owned property, finance, skills, track record â€” and a scene it
...
- **Persist Scout''s cooldowns.** They reset on restart, so a long campaign
  ...
  the next one.
- ~~**Retire the legacy colour aliases.**~~ **Mostly done** — what remained of the dark-only assumption was six hardcoded hover and focus backgrounds, now derived from the ground. The `--good/--warn/--bad` names themselves do flip correctly and stay. `--good/--warn/--bad` still bypass the
  one-ramp discipline. File by file, not in one change.
- ~~**Permits and the inspector queue.**~~ **Done**, with a deliberate re-baseline — the discipline-versus-recklessness gap widened from 30 points to 37. The only unbuilt *system* from the
  handoff. It will move balance â€” re-baseline deliberately.
...
game â€” measured, zero occasions across eight campaigns â€” which is a design
...
Sections 2â€“6 predate this push and were **not** re-researched when section 7
