# filepath: c:\Users\iphoe\OneDrive\Documents\GitHub\Property-Flipper-Game\game\ui\game_over_screen.py
import pygame
...
class GameOverScreen:
    ...
    def render(self, screen):
        # Title
        title_surf = self.font_title.render("Game Over", True, (200, 0, 0)) # Red color
        title_rect = title_surf.get_rect(center=(SCREEN_WIDTH // 2, 150))
        screen.blit(title_surf, title_rect)

        # Info Text
        info_text = "You went bankrupt!"
