    ...
    >
      <div className="panel">
        ...
        <div className="panel-body">
          ...
          <Step
            n={7}
            title="Sell"
            body="List price drives buyer traffic steeply. Overpricing does not cost you a little time — it costs you months of carry. And anything you left unrepaired comes back as a buyer's concession at 1.15× what the fix would have cost."
          />
        </div>
      </div>
      ...
      <div className="panel">
        ...
        <div className="panel-body">
          ...
          <p style={{ marginTop: 0 }}>
            ...
            deal and breaks on an atypical one — an expensive neighborhood, a long schedule, or high
            rates will eat the whole allowance.
          </p>
      ...
      <div className="panel">
        ...
        <div className="panel-body">
          ...
          <Term
            term="Comps"
            def="Recent sales of similar homes. They are similar, not identical, which is why your estimate carries a range rather than a number."
          />
        </div>
      </div>
      ...
      <div className="panel">
        ...
        <div className="panel-body">
          <ul style={{ margin: 0, paddingLeft: 20, lineHeight: 1.7 }}>
            ...
            <li>Skipping the inspection to save {money(ECON.INSPECTION.standard.cost)}, then meeting the same defects as change orders at full price with no seller concession.</li>
            <li>Budgeting no contingency, so the first surprise comes out of the cash you needed for the rest of the job.</li>
            <li>Listing above value and waiting. Buyer traffic falls off a cliff above true value, and the carry never stops.</li>
            <li>Leaving a known defect unrepaired. The buyer's inspector finds it and asks for more than the repair would have cost.</li>
            <li>Using leverage on a long schedule. Points are charged up front and the balloon does not care whether the house sold.</li>
          </ul>
        </div>
      </div>
    </Modal>
